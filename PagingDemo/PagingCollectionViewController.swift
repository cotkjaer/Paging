...
class PagingCollectionViewController: UICollectionViewController
{
    override func viewDidLoad()
    {
        ...
        collectionView?.collectionViewLayout = Paging.PagingCollectionViewFlowLayout(flowLayout: flowLayout)
    ...
    */
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.contentView.backgroundColor = UIColor(red: rand(), green: rand(), blue: rand(), alpha: 1)
